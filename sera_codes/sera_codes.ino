...
void loop() {
  ...
  if(isSeraWorking) {
    ...
    BTgidenVeri = (String)airHumidity + " " + (String)airTemperature + " " + (String)SMveri + " " + (String)RainVeri + " " + (String)LDR_1 + " " + (String)LDR_2 + " " + (String)pilYuzde;

    if(bluetoothVeri == ' '){
      Serial.println(BTgidenVeri);
    }
...
void akim() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    pilYuzde = currentVoltage / 8.4 * 100;
